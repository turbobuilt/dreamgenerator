...
class FlashSelfAttention(nn.Module):
    ...
    def __init__(self, causal=False, softmax_scale=None, attention_dropout=0.0, window=(-1,-1)):
        super().__init__()
...
class MHA(nn.Module):
    ...
    def __init__(
        ...
        # print(window_size, use_flash_attn)
        assert use_flash_attn == True or window_size == (-1,-1), "You must use Flash Attention to set window_size"
        ...
        self.inner_attn = inner_attn_cls(
            causal=causal, softmax_scale=softmax_scale, attention_dropout=dropout, window=window_size
        )
